...
class EnderecosControllerTest < ActionController::TestCase
  ...
  test "should create endereco" do
    assert_difference('Endereco.count') do
      post :create, endereco: { bairro: @endereco.bairro, cep: @endereco.cep, cidade: @endereco.cidade, contato_id: @endereco.contato_id, rua: @endereco.rua, uf: @endereco.uf }
    end
  ...
  test "should update endereco" do
    patch :update, id: @endereco, endereco: { bairro: @endereco.bairro, cep: @endereco.cep, cidade: @endereco.cidade, contato_id: @endereco.contato_id, rua: @endereco.rua, uf: @endereco.uf }
    assert_redirected_to endereco_path(assigns(:endereco))
  end
